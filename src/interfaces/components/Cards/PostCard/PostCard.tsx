...
function PostCard(props: PropType) {
    //
    ...
    return (
        <Skeleton.Group show={showSkeleton.skeleton} transition={{ type: 'timing', delay: 2000 }}>
            <TouchableOpacity
                activeOpacity={0.5}
                onPress={() => handle('navigate')}
                disabled={skeleton}
                style={[styles.container, showSkeleton ? styles.skeleton : null]}
                //
            >
                {/********** Replied | BOOST ***********/}
                {data.reblog ? (
                    <Skeleton width={40}>
                        <View style={styles.boostContainer}>
                            ...
                            />
                            <Text style={styles.boostUserName}>
                                {data.reblog?.account.display_name}
                            </Text>
                ...
                <View style={styles.secondryContainer}>
                    <Skeleton
                        colorMode="dark"
                        width={styles.authorProfilePic.width}
                        height={styles.authorProfilePic.height}
                        radius={styles.authorProfilePic.borderRadius}>
                        <Image
                            source={{ uri: data.account.avatar }}
                            style={styles.authorProfilePic}
                        />
                    </Skeleton>
                    <View style={[styles.thirdContainer, showSkeleton ? styles.skeleton : null]}>
                        {/********** AUTHOR INFO ***********/}
                        <Skeleton>
                            <View>
                        ...
                        <View style={styles.accessibility}>
                            {isLongContent.isLong && !showSkeleton ? (
                                <TouchableOpacity
                            ...
                            {activePreview?.description && !showSkeleton ? (
                                <TouchableOpacity
                                    onPress={() => handle('alt')}
                        ...
                        {/********** POST Media ***********/}
                        {activePreview?.url ? (
                            <Skeleton show={showSkeleton.media}>
                        ...
                        <Skeleton>
                            ...
                            <View style={styles.actionContainer}>
                                <View style={styles.action}>
                                    ...
                                    <StarIcon
                                        fill={data.favourited ? COLORS.success : COLORS.actionIcon}
                                    />
                                </View>
                                <View style={styles.action}>
                                    <Text
                                    ...
                                    <BoostIcon
                                        fill={data.reblogged ? COLORS.success : COLORS.actionIcon}
                                    />
                                </View>
                                <View style={styles.action}>
