...
export default function PostCard(props: PropsType) {
    ...
    const query = queryStatus(
        data?.in_reply_to_id ? data.in_reply_to_id : undefined,
    );
    ...
    return (
        <View style={styles.container}>
            ...
            {_data.reblog?.account ? (
                <View style={styles.boostContainer}>
                    <Image
                        ...
                        source={{uri: _data.reblog.account.avatar}}
                    />
                    <AuthorName
                        reblog
            ...
            {/* ********* Link | Article ********** */}
            {data.card && data.media_attachments.length < 1 ? (
                <LinkPreview inReply={inReply} card={data.card} />
            ) : null}
            ...
            <View style={styles.actionContainer}>
                <TouchableOpacity style={styles.actionButton}>
                    ...
                    <StarIcon
                        fill={
                            data.favourited ? COLORS.success : COLORS.actionIcon
                        }
                    />
                </TouchableOpacity>
                <TouchableOpacity style={styles.actionButton}>
                    ...
                    <BoostIcon
                        fill={
                            data.reblogged ? COLORS.success : COLORS.actionIcon
                        }
                    />
                </TouchableOpacity>
                <TouchableOpacity style={styles.actionButton}>
